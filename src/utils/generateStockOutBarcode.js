...
export async function generateStockOutBarcode(detailsObject, { filename = 'stock-out-barcode', format = 'png', autoDownload = false, width = 2, height = 80, displayValue = false } = {}) {
